class Trip {
  ...
  Trip.fromJson(Map data) {
    ...
    tpep_dropoff_datetime = DateTime.fromMillisecondsSinceEpoch(
        data["tpep_dropoff_datetime"] * 1000);
    ...
    tpep_pickup_datetime = DateTime.fromMillisecondsSinceEpoch(
        data["tpep_pickup_datetime"] * 1000);
  }
}
